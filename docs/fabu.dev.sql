...
CREATE TABLE `app` (
  ...
  UNIQUE KEY `uk_platform_bundle_id` (`platform`,`bundle_id`),
...
CREATE TABLE `app_version` (
  ...
  `description` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '更新说明',
  `size` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '包大小',
  `hash` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'hash',
  `path` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '文件存放路径（如果上传到云平台这里是url）',
  `is_publish` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '是否发布（0：未发布，1：发布）',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '状态（1：删除，2有效）',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `updated_by` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '修改人',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `created_by` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '添加人',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `member` (
  ...
  `mobile` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '手机',
  `account` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '登录账户',
  ...
  `email` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '邮箱',
  `token` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Token',
  `api_token` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'API Token',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '状态（1：删除，2有效）',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `updated_by` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '修改人',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
VALUES
	(1,1,'测试团队',2,'2020-12-03 18:22:32','','2020-12-03 18:22:32','admin'),
	(2,1,'测试2',2,'2021-01-21 17:36:38','','2021-01-21 17:36:38','admin');
...
VALUES
	(1,1,1,3,'2020-12-03 18:22:33','','2020-12-03 18:22:33','admin'),
	(2,2,1,3,'2021-01-21 17:36:38','','2021-01-21 17:36:38','admin');
